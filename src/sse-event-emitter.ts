...
function channelSubscribe(channels: string[], handler: (payload: SSEEvent) => void): void {
  channels.forEach((channel) => {
    emitter.on(channel, handler);
  });
}

function channelUnsubscribe(channels: string[], handler: (payload: SSEEvent) => void): void {
  channels.forEach((channel) => {
